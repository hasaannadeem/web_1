<?php
/*
function addnumber: int($arr, $ops){
	if(is_array($arr)){
		if($ops == "add"){
			return (int)"sdfdsf";
		}
...
echo addnumber("DSFDS", "addd");
echo '<pre>';
$date = date("m-d-Y H:i:s");
echo $date, "\n";
echo strtotime("now"), "\n";
echo strpos($date, '2019'), "\n";

$unixtime = strtotime("now");
echo date("m/d/y h:i:s A", $unixtime);
...
<form action="" method="post">
	<input type="text" name="valueone" value="<?php if(isset($_POST["valueone"]))? "":""; echo $_POST["valueone"]; else echo "20"; ?>"/>
